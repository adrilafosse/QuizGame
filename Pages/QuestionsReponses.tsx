...
const QuestionsReponses: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const { uniqueId, nombrePages, idAdmin } = route.params as RouteParams;
  ...
  const questionSuivante = () => {
    if (page < nombrePages) {
      ...
      setreponse3('');
      setreponse4('');
      navigation.navigate('Questions réponses', { uniqueId, nombrePages, page, idAdmin });
    ...
    <View style={styles.container}>
     ...
     {compteur === 3 ? (
      ...
      {page < nombrePages ? (
        ...
        <TouchableOpacity 
          style={styles.bouton} 
          onPress={() => {navigation.navigate('Terminer', { uniqueId, idAdmin }); Firebase() }}
        >
